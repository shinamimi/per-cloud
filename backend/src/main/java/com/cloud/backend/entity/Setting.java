 ...
 * - 【习惯】修改 settingKey         → String settingKey；对应 t_setting.setting_key，有唯一约束，业务通过 key 读取配置，
 *                            改 key 需同步 Service 读取处与 DDL
 * - 【习惯】修改 settingValue       → String settingValue；对应 t_setting.setting_value（VARCHAR(255)），数值型配置
